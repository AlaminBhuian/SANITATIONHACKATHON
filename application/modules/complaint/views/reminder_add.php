...
<form action="<?php echo site_url('complaint/reminder/saveReminder');?>" method="post"  name="frmReminder" id="frmReminder">
  ...
  <p>
    ...
    <input name="txtAlertDT[]" type="text" class="sf datePicCal dateISO required" value="" maxlength="10" />
  ...
  <p>
    ...
    <input name="txtEndDate[]" type="text" class="sf datePicCal dateISO" id="selEndDate" value="" maxlength="10" />
    <span class="bangla">সময় </span>(Time)
