  ...
  <div id="full-content">
    <div id="full-main">
      ...
      <div class="pad20">
		...
		?>
        <div class="information"> Complaint Submitted Successfully <br />
          <br />
          <ul>
            <li><span class="bangla">অভিযোগকারীর নাম </span>(Complainant Name): <strong><?php echo $complaintInfo->complaint_name; ?></strong></li>
        ...
        <div >
          ...
          <ul class="dash">
            ...
            <li> <a href="<?php echo site_url('complaint/printDetail');?>/<?php echo $complaintInfo->complaint_id; ?>" title="Print Complaint" class="tooltip" target="_blank"><img src="assets/assets/icons/9_48x48.png" alt="" /> <span>Print Complaint</span></a> </li>
          </ul>
        <hr />
        </div>
      </div>
